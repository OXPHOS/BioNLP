...
def merge_input_data(file_path, input_files, filename):
    """
...
def merge_input_and_labels(file_path, input_files, filename=None):
    """
...
def process_by_datasets(data_dir_name, output_to_file=True, check_integrity=True):
    """
    ...
    if output_to_file:
        merge_input_data(file_path, input_files, 'entity_list_%s.tsv'%data_dir_name)
        merge_input_and_labels(file_path, input_files, 'entity_and_label_list_%s.tsv'%data_dir_name)
    else:
